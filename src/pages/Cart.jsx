...
import {incrementQuantity,decrementQuantity,removeCartItem, emptyCart} from "../redux/slices/cartSlice";
      ...
      <div style={{ paddingTop: "100px" }} className="0x-5">
        {userCart?.length > 0 ? (
                  ...
                  <tbody>
                    {userCart?.map((product, index) => (
                      <tr>
                        ...
                        <td>
                          <button onClick={()=>dispatch(removeCartItem(product?.id))} className="text-red-600">
          ...
          <div className="flex justify-center items-center h-screen">
            <img
              src="https://grocarto.com/assets/images/User/gif/cartGif.gif"
              alt=""
            />
